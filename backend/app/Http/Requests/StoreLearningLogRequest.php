...
class StoreLearningLogRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'studied_on' => 'required|date|before_or_equal:today',
            ...
            'process_breakdown' => 'nullable|string|max:10000',
            'implementation_steps' => 'nullable|string|max:10000',
            'code_snippet' => 'nullable|string|max:10000',
            'open_questions' => 'nullable|string|max:10000',
